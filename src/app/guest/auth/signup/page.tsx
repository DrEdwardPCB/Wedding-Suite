...
export default async function GuestSignupPage(){
     ...
     * text-amber-300 text-zinc-400 text-yellow-700 font-bold bg-green-400 bg-red-400 outline-2 outline-offset-2  outline-green-400 outline-red-400 outline bg-themeDark disabled:bg-slate-400 disabled:opacity-50
    */
    return (<div className="flex h-full flex-col items-center justify-around gap-4">
