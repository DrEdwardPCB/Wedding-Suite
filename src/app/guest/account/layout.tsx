    ...
    <div className="h-[100vh] w-[100vw] bg-[#EFEEEA] relative p-2 flex flex-col items-stretch overflow-hidden relative flex flex-col justify-center items-center">
      ...
      <div className="absolute flex top-0 left-0 right-0 bottom-0 p-6">
        <div className="flex-1 relative">
          ...
          {/* Diagonal border */}
          <div
            className="absolute top-[90%] bottom-0 right-0 left-[90%] bg-[#D59D77] "
            style={{
              clipPath: 'polygon(0% 100%, 0% calc(100% - 2px), calc(100% - 2px) 0%, 100% 0%)',
            }}
          />
        </div>
      </div>
      <div className="absolute flex top-0 bottom-0 left-0 right-0 bottom-0 ">
        <div className="h-full w-full relative">
          <img
            className="absolute right-[-25px] top-[-25px] sm:right-[-25px] sm:top-[-75px] w-32 sm:w-52 rotate-[180deg] aspect-square"
            src="/sprite/plantCorner2.png"
          ></img>
          <img
            className="absolute left-[-5px] bottom-[-50px] sm:left-[-5px] sm:bottom-[-100px]  w-40 sm:w-72 rotate-[15deg] aspect-square"
            src="/sprite/plantCorner2.png"
          ></img>
        </div>
      </div>
      <div className="flex-1 z-50 p-10">
        <div className="flex h-full flex-col items-center justify-around">
          <h1 className=" font-modelsignature text-5xl md:text-9xl  p-12">Account</h1>
          {children}
        </div>
      </div>
    </div>
