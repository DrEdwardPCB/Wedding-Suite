...
import { z } from 'zod';
export const ZodRegisterEmailEntry = z
  .object({
...
const BaseRegisterPersonalDetail = z.object({
...
export const ZodRegisterPersonalDetail = BaseRegisterPersonalDetail.refine(
  schema => {
...
const BaseRegisterRemaining = z.object({
  online: z.boolean(),
  ceremony: z.boolean(),
  cocktail: z.boolean(),
  banquet: z.boolean(),
...
export const ZodRegisterRemaining = BaseRegisterRemaining.refine(schema => {
  if (schema.banquet) {
...
export const ZodEditGuestDetail = BaseRegisterPersonalDetail.merge(BaseRegisterRemaining)
  .extend({
