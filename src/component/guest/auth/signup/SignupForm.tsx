...
import {
  keyToDisplay,
  valueToDisplay,
  ZodRegisterEmailEntry,
  ZodRegisterPersonalDetail,
} from '@/lib/xstate/registerHelper';
        ...
        <div className="w-full flex items-center mt-7 justify-between gap-4 md:px-2">
          ...
          <div className="flex flex-col max-w-40 md:max-w-52">
            ...
            <p className="text-xs text-slate-400">
              Email information is used to send rsvp email and for login
            </p>
          </div>
            ...
            >
              <TextField
                ...
                helperText={
                  errors.email && touched.email
                    ? errors.email
                    : 'This email address will be use as your identifier to login upon wedding days'
                }
              ...
              <TextField
                ...
                helperText={
                  errors.reenterEmail && touched.reenterEmail
                    ? errors.reenterEmail
                    : 'To double confirm your email is correct'
                }
              ...
              <div className="flex justify-end items-center gap-2 w-full">
                <LoadingButton
                  ...
                  disabled={
                    _.size(errors) > 0 &&
                    _.size(touched) === _.size(structuredClone(state.context.emailField))
                  }
                  type="submit"
                >
                  Next
      ...
      <div className="shadow rounded-xl flex items-center justify-center bg-white  max-h-[450px] w-82 md:w-96 overflow-y-auto flex-col relative">
        <div className="w-full flex items-center mt-7 justify-between gap-4 px-2">
          ...
          <div className="flex flex-col max-w-40 md:max-w-52">
            <p>Send RSVP</p>
            <p className="text-xs text-slate-400">
              Click the below button to send an RSVP and login information to your email{' '}
            </p>
          </div>
          <div className="flex-1"></div>
        </div>
        ...
        <div className="flex flex-col items-center justify-start gap-4 p-7">
          <div className="flex justify-end items-center gap-2 w-full">
            <LoadingButton
              className="font-bevietnam text-white bg-themeDark shadow-black disabled:bg-slate-400 disabled:opacity-50"
              onClick={async () =>
                await handleSendRsvp(
                  (await getUserIdByEmail(state.context.emailField.email as string)) as string,
                )
              }
              type="button"
              variant="contained"
        ...
        <div className="overflow-y-auto w-full">
          <div className="w-full flex items-center mt-7 justify-between gap-4 px-2">
            ...
            <div className="flex flex-col max-w-40 md:max-w-full">
              ...
              <p className="text-xs text-slate-400">
                Personal information are collected to ease registration logistic and preparation of
                the wedding
              </p>
            </div>
            <div className="flex-1"></div>
              ...
              >
                ...
                <div className="flex justify-center items-center gap-2 w-full md:col-span-6">
                  <LoadingButton
                    ...
                    disabled={
                      _.size(errors) > 0 &&
                      _.size(touched) === _.size(structuredClone(state.context.personalField))
                    }
                    type="submit"
                    onClick={() => {
                      setTimeout(() => {
      ...
      <div className="shadow rounded-xl flex items-center justify-center bg-white  max-h-[450px] w-82 md:w-96 overflow-y-auto flex-col relative">
        <div className="w-full flex items-center mt-7 justify-between gap-4 px-2">
          ...
          <div className="flex flex-col max-w-40 md:max-w-52">
            ...
            <p className="text-xs text-slate-400">
              Add any additional remarks you have for virtual ceremony
            </p>
          </div>
          <div className="flex-1"></div>
        </div>
      ...
      <div className="shadow rounded-xl flex items-center justify-center bg-white  max-h-[450px] w-82 md:w-96 overflow-y-auto flex-col relative">
        <div className="w-full flex items-center mt-7 justify-between gap-4 px-2">
          ...
          <div className="flex flex-col max-w-40 md:max-w-52">
            <p>Food Allergies</p>
            <p className="text-xs text-slate-400">
              Food Allergies such that we can notify our banquet provider
            </p>
          </div>
          <div className="flex-1"></div>
        </div>
        ...
        >
          {({ values, errors, touched, handleChange, handleBlur, handleSubmit }) => (
            <form
              className="flex flex-col items-center justify-start gap-6 p-7"
              onSubmit={handleSubmit}
            >
              <TextField
                size="small"
      ...
      <div className="shadow rounded-xl flex items-center justify-center bg-white h-[500px] max-h-[450px] w-82 md:w-2/3  flex-col relative">
        <div className="w-full flex items-center mt-7 justify-between gap-4 px-2 ">
          ...
          <div className="flex flex-col max-w-40 md:max-w-full">
            <p>Send RSVP</p>
            <p className="text-xs text-slate-400">
              Click the below button to create account and receive RSVP Email{' '}
            </p>
          </div>
          <div className="flex-1"></div>
        </div>
          ...
          <div className=" shadow-inner h-40 md:h-52 -z-10 overflow-y-scroll w-full">
            {Object.entries(state.context.emailField).map(([key, value], i) => {
              ...
              return (
                <div
                  key={`${i}emailfield`}
                  className="flex items-center justify-between px-4 py-2 border-b border-b-[1px] border-slate300"
                >
