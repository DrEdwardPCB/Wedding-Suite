      ...
      <div className="w-full flex items-center mt-7 justify-between gap-4 md:px-2">
        ...
        <div className="flex flex-col max-w-40 md:max-w-52">
          ...
          <p className="text-xs text-slate-400">
            The signin credentials has been sent to you in the RSVP email, if not please refer to
            the email
          </p>
        </div>
        ...
        {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
          ...
          >
            ...
            <TextField
              ...
              helperText={
                errors.password && touched.password ? errors.password : 'Password on the RSVP email'
              }
              sx={{
                '& .MuiFormHelperText-root': {
                  width: 250,
